...
The input/output folders in \materiel\ have a test photo which you can immediately enter into the AHCE and get a feel for what you're working with. Feel free to replace this with any .jpg or .png images.
...
process it is, and then "taskkill /f im PROCESS_ID" to free up the port.
